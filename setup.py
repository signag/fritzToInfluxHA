...
setup(
    ...
    description="Periodially read Fritz!Box HA device data and store in InfluxDB",  # Optional
    ...
    url="https://github.com/signag/fritzToInfluxHA",  # Optional
    ...
    keywords="RaspberryPi Fritz!Box HomeAutomation Monitoring InfluxDB",  # Optional
